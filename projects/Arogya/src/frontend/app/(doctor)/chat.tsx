    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        >
          ...
          <View style={styles.messageRight}>
            <View style={styles.bubbleRight}>
              <Text style={styles.textRight}>
                Hello Dr. Vance, I{"'"}ve been feeling a bit of recurring pain
                in my lower back since the exercises we discussed on Tuesday.
              </Text>
            </View>
          ...
          <View style={styles.messageLeft}>
            <View style={styles.bubbleLeft}>
              <Text style={styles.textLeft}>
                Hello! I{"'"}m sorry to hear that. Could you pinpoint exactly
                where the pain is? Is it more sharp or a dull ache?
              </Text>
            </View>
          ...
          <View style={styles.messageRight}>
            <View
              style={[styles.bubbleRight, { padding: 0, overflow: "hidden" }]}
            >
              <Image
                source={{
                  uri: "https://images.unsplash.com/photo-1608265386093-9b240ca8c322?w=500&q=80",
                }}
                style={styles.attachedImage}
              />
              <Text style={[styles.textRight, { padding: 16 }]}>
                It{"'"}s right around this area marked here. It feels more like
                a dull ache that intensifies when I sit for too long.
              </Text>
            </View>
          ...
          <View style={styles.messageLeft}>
            <View style={styles.bubbleLeft}>
              <Text style={styles.textLeft}>
                Understood. That sounds like it might be postural stress. I{"'"}
                ve uploaded a modified stretch routine for you to try this
                morning. Can you review this?
              </Text>
            </View>
        ...
        <View style={styles.inputContainer}>
          ...
          >
            <TouchableOpacity
              style={[styles.quickReplyChip, { backgroundColor: LIGHT_GREEN }]}
            >
              <Text style={[styles.quickReplyText, { color: "#1B5E20" }]}>
                Thank you
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.quickReplyChip, { backgroundColor: LIGHT_BLUE }]}
            >
              <Text style={[styles.quickReplyText, { color: BLUE }]}>
                Yes, I can
              </Text>
            </TouchableOpacity>
